...
// CertPool appends RootCA to the https server TLS config
func CertPool(rootCa string) (*x509.CertPool, error) {
...
// InitTLSConfig initializes *tls.Config which can be used in the https/grpc servers
